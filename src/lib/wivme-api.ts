...
const STUDENT_APK_URL = 'https://github.com/AnshuMishra01/WivmeWebsite/releases/download/v1.0.5/wivme-student-v1.0.5.apk';
const PARENT_APK_URL = 'https://github.com/AnshuMishra01/WivmeWebsite/releases/download/v1.0.2-parent/wivme-parent-v1.0.2.apk';
